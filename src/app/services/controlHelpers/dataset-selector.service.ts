...
export class DatasetSelectorService {
  ...
  //each subclass should have a date extent that cover all periods of production
//if a particular production method yields different time ranges for different periods then just categorize it as multiple subclasses

//  defs: DatasetDefs = {
//   rainfall: {
//      new: {
//       timerange: {
//         start: moment("1990-01"),
//         end: moment("2019-12")
//       },
//       periods: {
//         monthly: {
//           exportItems: new Set<ExportItem>(["raster", "station", "anomaly", "standard_error", "LOOCV_error", "metadata"]),
//           visItems: new Set<VisItem>(["raster", "station"])
//          },
//          daily: {
//           exportItems: new Set<ExportItem>(["station"]),
//           visItems: new Set<VisItem>(["station"])
//          }
//       }
//      }
//   }
...
// export interface DatasetDefs {
//     [classification: string]: Subclassifications
// }

// export interface Subclassifications {
//   [subclassification: string]: {
//     timerange: {
//       start: Moment,
//       end: Moment
